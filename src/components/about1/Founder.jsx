...
import founder from '../../assets/abouts/founder(1).jpg'
    ...
    return (
        <section className="py-24  bg-violet-100 ">
            ...
            <div className="w-11/12 lg:w-10/12 mx-auto flex flex-col md:gap-y-16 gap-y-12 ">
                ...
                <h1 className="xmd:text-[42px] xs:text-4xl text-3xl font-semibold text-center">About The Founder</h1>

                <div className='rounded-lg border p-4  flex xmd:flex-row flex-col gap-x-6 justify-between'>

                    {/* --------- left ------------ */}

                    <div className='xmd:w-[35%] md:w-[400px] xs:w-[320px] w-[95%] xmd:mx-0 mx-auto flex flex-col gap-y-6 items-center bg-violet-50 py-12 px-4 rounded-lg text-white'>
                    ...
                    <div className='xmd:w-[60%] md:text-lg text-base flex flex-col gap-y-4 py-12'>
