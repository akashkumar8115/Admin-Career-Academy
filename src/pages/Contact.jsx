...
const Contact = () => {
    ...
    return (
        <div className="pt-24 min-h-screen bg-gradient-to-b from-white to-green-100 mt-28">
            <div className="w-11/12 lg:w-10/12 mx-auto pb-16">
                ...
                <div className='flex xmd:flex-row  items-center flex-col-reverse gap-x-12 '>


                    {/* -------- img ------- */}

                    <div className='xmd:w-[35%]'>
                        <img src={contact} alt="contact-us" />
                    </div>


                    {/* Contact Form Section */}
                    <div className="xmd:w-[60%] w-full mx-auto mb-16">
